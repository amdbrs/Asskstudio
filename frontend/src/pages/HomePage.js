            ...
            {portfolio.slice(0, 6).map((item, index) => (
              <AnimatedSection key={item.id} animation="fadeInUp" delay={index * 100}>
                <TiltCard maxTilt={8} scale={1.02} className="h-full">
                  ...
                  >
                    <article className="relative overflow-hidden bg-white border-2 border-[#0047FF]/10 hover:border-[#0047FF] transition-all duration-500 hover:shadow-[0_30px_60px_-15px_rgba(0,71,255,0.25)] h-full">
                      {/* Image container */}
